...
export const ui = {
	en: {
		...
		'page.products.filter.solvents': 'Solvents',
		'page.products.filter.acids': 'Acids',
		'page.products.filter.salts': 'Salts',
		'page.products.filter.chromatography_standards': 'Chromatography Standards',
		'page.products.filter.hplc_buffers': 'HPLC Buffers',
		'page.products.filter.caustic_alkalis_bases': 'Caustic Alkalis & Bases',
		'page.products.filter.karl_fischer': 'Karl Fischer Reagents and Standards',
		'page.products.filter.indicators': 'Indicators',
		'page.products.filter.titration_reagents': 'Titration Reagents',
		'page.products.filter.ph_conductivity': 'pH & Conductivity Standards',
		'page.products.filter.aas_icp_standards': 'AAS & ICP Standards',
		'page.products.filter.ion_chromatography_standards': 'Ion Chromatography Standards',
		'page.products.filter.pesticide_standards': 'Pesticide Standards',
		'page.products.filter.pharma_qc_standards': 'Analytical Reference Materials for Pharmaceutical QC',
		'page.products.filter.organic_pollutant_standards': 'Organic Pollutant Standards',
	...
	ar: {
		...
		'page.products.filter.solvents': 'المذيبات',
		'page.products.filter.acids': 'الأحماض',
		'page.products.filter.salts': 'الأملاح',
		'page.products.filter.chromatography_standards': 'معايير الكروماتوغرافيا',
		'page.products.filter.hplc_buffers': 'محاليل HPLC المنظمة',
		'page.products.filter.caustic_alkalis_bases': 'القلويات والقواعد الكاوية',
		'page.products.filter.karl_fischer': 'كواشف ومعايير كارل فيشر',
		'page.products.filter.indicators': 'المؤشرات',
		'page.products.filter.titration_reagents': 'كواشف المعايرة',
		'page.products.filter.ph_conductivity': 'معايير الـ pH والموصلية',
		'page.products.filter.aas_icp_standards': 'معايير AAS و ICP',
		'page.products.filter.ion_chromatography_standards': 'معايير الكروماتوغرافيا الأيونية',
		'page.products.filter.pesticide_standards': 'معايير المبيدات',
		'page.products.filter.pharma_qc_standards': 'مواد مرجعية تحليلية لضبط الجودة الصيدلانية',
		'page.products.filter.organic_pollutant_standards': 'معايير الملوثات العضوية',
