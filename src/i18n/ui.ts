...
export const ui = {
	en: {
		...
		'page.products.glasswares.filter.cuvettes': 'Cuvettes',
		'page.products.glasswares.filter.vials': 'Chromatography Vials',
		'page.products.glasswares.filter.filtration': 'Filtration',
	...
	ar: {
		...
		'contact.subject.placeholder': 'بخصوص ماذا؟',
		...
		'page.products.glasswares.filter.cuvettes': 'خلايا طيفية (Cuvettes)',
		'page.products.glasswares.filter.vials': 'فيالات الكروماتوغرافيا',
		'page.products.glasswares.filter.filtration': 'أدوات الترشيح',
